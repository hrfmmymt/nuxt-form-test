      ...
      <v-container>
        ...
        >
          ...
          <section v-if="speech.enable">
            ...
            <v-checkbox
              v-model="speech.enableTimeStamp"
              label="timeStamp を付与する"
            ></v-checkbox>
          </section>
          <div class="privacy-notes">
            <section class="privacy-notes__inner">
              ...
              <section class="privacy-notes__section">
                <h5 class="privacy-notes__subtitle">
                  【個人情報の第三者への提供について】
                </h5>
                <p>
              ...
              <section class="privacy-notes__section">
                ...
                <p>
                  ...
                  <br />株式会社 仕様「個人情報窓口」 <br />TEL: 00-0000-0000
                  <br />個人情報保護管理者：仕様 太郎
                </p>
              </section>
            </section>
